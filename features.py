...
print('recall data to df success!')
...
print('negative sampling success!')
...
print('recall_df to dict success!')

print('start features engine!')
# 下面基于data做历史相关的特征
...
print('start users and articles features')
print('start users features')
# 读取文章特征
...
print('time hobit features success!')
...
print('word count hobit success!')
...
print('start load article features')
articles =  pd.read_csv(data_path+'articles.csv')
articles = reduce_mem(articles)
