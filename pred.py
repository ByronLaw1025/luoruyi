...
submit(rank_results, topk=5, model_name='lgb_ranker0')

print('simgle LGB Rank success')
print('Start 5-folds LGB Rank')
...
print('5-Fold LGB Rank success')

print('Start LGB Classify')
# 模型及参数的定义
...
rank_results = tst_user_item_feats_df[['user_id', 'click_article_id', 'pred_score']]
rank_results['click_article_id'] = rank_results['click_article_id'].astype(int)
submit(rank_results, topk=5, model_name='lgb_cls0')

print('Simgle LGB Classify success!')
print('Start 5-Fold LGB Classify')
...
print('5-Fold LGB Classify success!')
...
submit(rank_results, topk=5, model_name='din0')

print('simgle DIN success!')
print('Start 5-fold DIN')
...
print('5-fold DIN success!')

print('----Fusion----')
print('Start weight fusion')
# 读取多个模型的排序结果文件
